...
const double VEHICLE_ORGIN_FROM_REAR = VEHICLE_FRONT_LENGTH + VEHICLE_REAR_LENGTH + VEHICLE_REAR_OVERHANG;    // vehicle orgin from vehicle rear over hang. orgin is center of front wheel
